...
def extract_scores_from_results(results, max_molecules=4, is_reference=False):
    ...
    Args:
        ...
        max_molecules: Maximum number of molecules to analyze (default: 4)
...
def analyze_pair(on_id, off_id, tmscore):
    ...
    models = {
        ...
        'Reference': results_dir / 'crossdocked_test_vina_docked' / f'id{on_id}_{off_id}_low' / 'docking_results' / 'docking_results.json',
        ...
        'TargetDiff2': results_dir / 'joint_pv_baseline_vina' / f'id{on_id}_{off_id}_low' / 'docking_results' / 'docking_results.json',
        ...
        # === NEW: On-guidance only models (w2_0) ===
...
def print_detailed_report(all_pairs_results, final_stats):
    ...
    print("=" * 160)
    print("DETAILED DOCKING RESULTS ANALYSIS FOR LOW TM-SCORE PAIRS")
    print("=" * 160)
...
def main():
    ...
    # Save to file
    output_file = 'tmscore_pairs_analysis_low_v3.txt'
