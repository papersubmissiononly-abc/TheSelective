...
from datasets.pl_pair_dataset import PocketLigandPairDataset, PDBPairDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_num_pockets', type=int, default=-1)
    parser.add_argument('--seed', type=int, default=2021)
    args = parser.parse_args()

    if args.mode == 'pdbbind':
        dataset = PDBPairDataset(args.path)
    elif args.mode == 'crossdock':
    ...
    if args.fixed_split:
        ...
        train_id, val_id, test_id = selected_ids['train'], selected_ids['val'], selected_ids['test']
